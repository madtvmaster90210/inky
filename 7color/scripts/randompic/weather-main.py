...
configObj.read(cwd + "configfile.ini")
...
img = Image.open(cwd + "resources/background/weather-report-bg.png")
...
draw.text((5, 4),TimeDate.strftime("%m-%d-%Y"), inky_display.BLACK, font2)	#Time
draw.text((368, 4),TimeDate.strftime("%H:%M"), inky_display.BLACK, font2)	#Date
draw.text((x_name, 4),projectName, inky_display.BLACK, font2)			#project name

draw.text((155, 65), currentTemp, inky_display.WHITE, font_big)				#Current temp
draw.text((292, 98), currentHiTemp, inky_display.WHITE, font_small)			#Current high temp
draw.text((292, 116), currentLoTemp, inky_display.WHITE, font_small)			#Current low temp

img.paste(LocationIcon, (15, 198)) 
draw.text((35, 200), currentLoc, inky_display.WHITE, font_medium2)			#Current location

draw.text((x_TwoHrTemp, 246), TwoHrTemp+degreeSign, inky_display.WHITE, font_medium)	#Temp in 2 hrs
draw.text((x_FourHrTemp, 246),FourHrTemp+degreeSign, inky_display.WHITE, font_medium)	#Temp in 4 hrs
draw.text((x_SixHrTemp, 246), SixHrTemp+degreeSign, inky_display.WHITE, font_medium)	#Temp in 6 hrs
draw.text((x_EightHrTemp, 246), EightHrTemp+degreeSign, inky_display.WHITE, font_medium)	#Temp in 8 hrs

draw.text((x_TwoHrCond, 283), TwoHrCond, inky_display.WHITE, font_tiny)			#Condition in 2 hrs
draw.text((x_FourHrCond, 283), FourHrCond, inky_display.WHITE, font_tiny)		#Condition in 4 hrs
draw.text((x_SixHrCond, 283), SixHrCond, inky_display.WHITE, font_tiny)			#Condition in 6 hrs
draw.text((x_EightHrCond, 283), EightHrCond, inky_display.WHITE, font_tiny)		#Condition in 8 hrs

draw.text((x_TwoHrsTime, 239), TwoHrsTime, inky_display.WHITE, font_tiny)			#Time in 2 hrs
draw.text((x_FourHrsTime, 239), FourHrsTime, inky_display.WHITE, font_tiny)		#Time in 4 hrs
draw.text((x_SixHrsTime, 239), SixHrsTime, inky_display.WHITE, font_tiny)		#Time in 6 hrs
draw.text((x_EightHrsTime, 239), EightHrsTime, inky_display.WHITE, font_tiny)		#Time in 8 hrs

draw.text((292, 150), currentHumidity, inky_display.WHITE, font_small)			#Current humidity in percentage
draw.text((292, 178), currentWind, inky_display.WHITE, font_small)		#Current wind speed in MPH

draw.text((292, 65), currentCond, inky_display.WHITE, font_small)		#Current weather conditions, short
